// Structure describing a single info card for the MadCourses page.
export type Card = {
  /** Image index used for the screenshot */
  image: number
  /** Optional icon displayed behind the screenshot */
  icon?: string
