...
/**
 * Page showing floating images and text using motion animations.
...
const TEXTS = ["Hello World", "Random Motion", "Next.js Demo", "Flying Text"]

const IMAGES = ["/icons/react.svg", "/icons/python.svg", "/icons/redux.svg"]

export default function Posthole() {
